var Scene = {
    ...
    request.onreadystatechange = function() {
      if (request.readyState == 4) {
        if (request.status == 404) {
          console.info(filename + ' dose not exsit');
        } else {
  ...
  addObject: function(object) {
    ...
    gl.bufferData(gl.ARRAY_BUFFER, new Fload32Array(Utils.calculateNormals(object.vertices, object.indice)), gl.STATIC_DRAW);
